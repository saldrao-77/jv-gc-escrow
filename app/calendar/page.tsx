    ...
    <main className="min-h-screen bg-black text-white pt-28 pb-16">
        ...
        >
          <div className="bg-zinc-900 rounded-lg max-w-lg w-full p-6 relative">
            ...
            <p className="text-white/80 mb-4 text-center">
              Thank you for your interest in JobVault. Our team will be reaching out to you shortly to discuss how our
              AI-powered escrow system can help your GC business eliminate deposit risks and build trust with your
              subcontractors.
            </p>
      ...
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-white/70 mb-10 max-w-2xl mx-auto">
          Schedule a personalized demo to see how JobVault's AI-powered escrow system can eliminate deposit risks,
          verify material purchases in real-time, and help you build stronger relationships with your subcontractors.
        </p>
